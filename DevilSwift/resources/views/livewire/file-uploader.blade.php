<div>
    <form wire:submit="save">
        ...
        <span>
            <input type="radio" id="public" wire:model="public_visibility" value="1" class="hidden peer"/>
        ...
        <span>
            <input type="radio" id="private" wire:model="public_visibility" value="0" class="hidden peer">
